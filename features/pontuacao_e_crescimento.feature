...
Funcionalidade: Aumentar a pontuação e o tamanho
  ...
  eu quero que a cobra cresça e a pontuação aumente ao comer um "Rato Normal".

Cenário: Cobra come um Rato Normal
  Dado que eu estou em uma partida com pontuação "50" e a cobra tem tamanho "10"
  E um "Rato Normal" está na célula à frente da cobra
  Quando a cobra se move e come o "Rato Normal"
